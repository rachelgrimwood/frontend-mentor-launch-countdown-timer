const FlipCard = ({ num, unit }) => {
  ...
  return (
    <div className="relative h-16 sm:h-20 md:h-32 lg:h-48 mt-14 md:mt-20 lg:mt-32 mx-2 sm:mx-3 lg:mx-6 shadow-[black_0px_5px_2.5px_-1.5px] lg:shadow-[black_0px_10px_5px_-3px]">
