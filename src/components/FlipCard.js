const FlipCard = ({ num, unit }) => {
  ...
  return (
    <div className="relative h-16 sm:h-20 md:h-32 lg:h-36 mt-16 md:mt-20 lg:mt-24 mb-20 sm:mb-16 mx-2 sm:mx-3 lg:mx-4 shadow-[black_0px_5px_2.5px_-1.5px] lg:shadow-[black_0px_8px_4px_-2px]">
